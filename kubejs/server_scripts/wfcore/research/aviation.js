...
ServerEvents.recipes(event => {
    ...
    WFResearch.builder('air_propellers')
        ...
        .runs(20).ticksPerRun(300).eut(EU_MV).cwuPerRun(19200)
    ...
    WFResearch.builder('air_ju_87')
        ...
        .runs(26).ticksPerRun(300).eut(EU_MV).cwuPerRun(19200)
        .itemPerRun(Item.of('gtceu:aluminium_plate', 6))
    ...
    WFResearch.builder('air_hercules')
        ...
        .requires('air_a_10')
        .runs(44).ticksPerRun(300).eut(EU_EV).cwuPerRun(307200)
    ...
    WFResearch.builder('air_b2')
        ...
        .requires('air_hercules')
        .runs(48).ticksPerRun(300).eut(EU_IV).cwuPerRun(1228800)
    ...
    WFResearch.builder('drone_tactics')
        ...
        .runs(15).ticksPerRun(300).eut(EU_MV).cwuPerRun(19200)
    ...
    WFResearch.builder('drone_swarm')
        ...
        .runs(20).ticksPerRun(300).eut(EU_HV).cwuPerRun(76800)
        .itemPerRun(Item.of('gtceu:aluminium_plate', 4))
    ...
    WFResearch.builder('drone_loitering')
        ...
        .requires('drone_tactics')
        .runs(23).ticksPerRun(300).eut(EU_HV).cwuPerRun(76800)
    ...
    WFResearch.builder('drone_fpv_spotlight')
        ...
        .requires('drone_fpv')
        .runs(12).ticksPerRun(300).eut(EU_HV).cwuPerRun(76800)
    ...
    WFResearch.builder('drone_fpv_jammer')
        ...
        .requires('drone_fpv')
        .runs(15).ticksPerRun(300).eut(EU_HV).cwuPerRun(76800)
    ...
    WFResearch.builder('air_comp_mv_air_frame')
        ...
        .runs(4).ticksPerRun(200).eut(EU_MV).cwuPerRun(12800)
    ...
    WFResearch.builder('air_comp_hv_air_frame')
        ...
        .runs(5).ticksPerRun(200).eut(EU_HV).cwuPerRun(51200)
    ...
    WFResearch.builder('air_comp_ev_air_frame')
        ...
        .runs(6).ticksPerRun(200).eut(EU_EV).cwuPerRun(204800)
