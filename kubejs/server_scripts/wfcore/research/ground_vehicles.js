...
ServerEvents.recipes(event => {
    ...
    WFResearch.builder('veh_wheel')
        ...
        .runs(10).ticksPerRun(600).eut(EU_LV).cwuPerRun(0)
    ...
    WFResearch.builder('veh_sodayo')
        ...
        .requires('veh_wheel')
        .runs(20).ticksPerRun(600).eut(EU_LV).cwuPerRun(0)
    ...
    WFResearch.builder('veh_comp_lv_vehicle_frame')
        ...
        .runs(3).ticksPerRun(400).eut(EU_LV).cwuPerRun(0)
    ...
    WFResearch.builder('veh_iv')
        ...
        .runs(8).ticksPerRun(400).eut(EU_IV).cwuPerRun(1638400)
