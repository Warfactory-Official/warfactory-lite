...
ServerEvents.recipes(event => {
    ...
    WFResearch.builder('missile_systems')
        ...
        .runs(4).ticksPerRun(2250).eut(EU_HV).cwuPerRun(576000)
    ...
    WFResearch.builder('tactical_nuclear')
        ...
        .runs(4).ticksPerRun(6750).eut(EU_IV).cwuPerRun(27648000)
    ...
    WFResearch.builder('penetrator_supersonic')
        ...
        .runs(4).ticksPerRun(4500).eut(EU_EV).cwuPerRun(4608000)
    ...
    WFResearch.builder('interceptor_systems')
        ...
        .requires('missile_systems')
        .runs(4).ticksPerRun(1500).eut(EU_HV).cwuPerRun(384000)
    ...
    WFResearch.builder('interceptor_network')
        ...
        .runs(4).ticksPerRun(3000).eut(EU_EV).cwuPerRun(3072000)
    ...
    WFResearch.builder('interceptor_ace')
        ...
        .runs(4).ticksPerRun(4500).eut(EU_IV).cwuPerRun(18432000)
    ...
    WFResearch.builder('interceptor_cluster')
        ...
        .requires('interceptor_network')
        .runs(4).ticksPerRun(4050).eut(EU_IV).cwuPerRun(16588800)
